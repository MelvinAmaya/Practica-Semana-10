...
# Melvin Adiel Vásquez Mejía SMIS001021
...
def calcular():
    try:
        ...
        if com == "":
            messagebox.showerror("Cajero","Sleleccione un metodo de pago...")
...
txt0 = Label(interfaz,text="SUPERMERCADO ",bg='dark turquoise',font='Helvetica 16 bold')
txt3 = Label(interfaz,text="Metodo de Pago: ",bg='dark turquoise',font='Helvetica 10 bold')
txt1 = Label(interfaz,text="Ingrese el precio del producto: ",bg='dark turquoise',font='Helvetica 9 bold')
caja1 = Entry(interfaz)
txt2 = Label(interfaz,text="Ingrese la cantidad de producto: ",bg='dark turquoise',font='Helvetica 9 bold')
caja2 = Entry(interfaz)
cambo = Combobox(interfaz,state="readonly")
cambo['values']=("Efectivo","Tarjeta Credito o debito")
btn1 = Button(interfaz,text ="Comprar",command=calcular,bg="red",font='Helvetica 10 bold',fg="white")
btn2 = Button(interfaz,text ="Cerrar",command=salir,bg="red",font='Helvetica 10 bold',fg="white")
